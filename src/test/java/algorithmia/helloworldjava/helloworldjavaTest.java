package algorithmia.helloworldjava;
...
/**
 * Unit test for helloworldjava algorithm
 */
public class helloworldjavaTest extends TestCase {
    /**
     * Create the test case
     *
     * @param testName name of the test case
     */
    public helloworldjavaTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(helloworldjavaTest.class);
    }
    ...
    public void testhelloworldjava() throws Exception {
        ...
        helloworldjava algorithm = new helloworldjava();
